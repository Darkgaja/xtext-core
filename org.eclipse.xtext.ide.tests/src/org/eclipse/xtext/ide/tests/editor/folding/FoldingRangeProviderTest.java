...
public class FoldingRangeProviderTest extends AbstractFoldingRangeProviderTest {
	...
	public void foldingRangesProvider() {
		...
		assertFoldingRanges(actual, new FoldingRange(0, actual.length()), new FoldingRange(typeIndex, typeLength), new FoldingRange(commentIndex, commentLength, FoldingRangeKind.COMMENT));
	}
